%% from IEEE style, converted to SmartGreens template 
...
\authorname{
Tae-Gil Noh\sup{1}, 
Daniel Schwabeneder\sup{2}, 
S\'ebastien Nicolas\sup{1}, 
Maja Schwarz\sup{1}, 
Anett Sch\"ulke\sup{1}, 
Hans Auer\sup{2}}  
\affiliation{\sup{1}NEC Laboratories Europe, Heidelberg, Germany}
\affiliation{\sup{2}Institute of Energy Systems and Electrical Drives,
  Vienna University of Technology, Vienna, Austria}
\email{
\{tae-gil.noh,
  sebastien.nicolas,maja.schwarz,anett.schuelke\}@neclab.eu, 
...
domains of energy grids, where energy can be transformed between
energy carriers. It is regarded as one good solution for managing
volatile renewable energy sources in a better way. The paper
introduces an investigation process that is designed to develop and
evaluate co-operative hybrid energy network control strategies. The
proposed investigation process consists of two-step holistic
investigation with simulation-based and economic-model based
...
\section{\uppercase{Co-operative Control Model as 
...
% This work has been done within EU FP7 OrPHEuS project. The OrPHEuS
% project is co-financed by the European Commission under the 7th
% Framework Programme. The sole responsibility for the content of this
% publication lies with the authors. It does not necessarily reflect the
% opinion of the European Commission. The European Commission is not
...
\bibliography{Orpheus_SmartGreens.bib}
