...
\author{\authorname{First Author Name\sup{1}, Second Author
    Name\sup{1}, Third Author Name\sup{2}, Fourth Author Name\sup{2}}
\affiliation{\sup{1}Institute name and address anonymized}
\affiliation{\sup{2}Institute name and address anonymized}
%\email{\{f\_author, s\_author\}@ips.xyz.edu, t\_author@dc.mu.edu}
\email{\{f\_author, s\_author\}@anonymized, \{t\_author, f\_author\}@anonymized}
}
